...
class Boat {
  ...
  public void draw() {
    ...
    triangle(
      30*cos(-0.95f*PI/2+PI/8*sin(PI/50*t))+pos.x, 30*sin(-0.95f*PI/2+PI/8*sin(PI/50*t))+pos.y,
      15*cos(-0.88f*PI/2+PI/8*sin(PI/50*t))+pos.x, 15*sin(-0.88f*PI/2+PI/8*sin(PI/50*t))+pos.y,
      20*cos(-PI/4+PI/8*sin(PI/50*t))+pos.x, 20*sin(-PI/4+PI/8*sin(PI/50*t))+pos.y
    );
    triangle(
      30*cos(-1.05f*PI/2+PI/8*sin(PI/50*t))+pos.x, 30*sin(-1.05f*PI/2+PI/8*sin(PI/50*t))+pos.y,
      15*cos(-1.12f*PI/2+PI/8*sin(PI/50*t))+pos.x, 15*sin(-1.12f*PI/2+PI/8*sin(PI/50*t))+pos.y,
